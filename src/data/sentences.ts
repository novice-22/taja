...
const LONG_KO: LongText[] = [
  ...
  },
  {
    title: '봄날의 기록',
    lines: [
      '봄이 오면 들판에 꽃이 피고 새들이 즐겁게 노래한다.',
      '따뜻한 햇살이 마을 곳곳을 부드럽게 어루만진다.',
      '아이들은 운동장으로 달려 나가 큰 소리로 웃는다.',
      '냇가에는 맑은 물이 졸졸 소리를 내며 흐른다.',
      '버드나무 가지에는 연둣빛 새잎이 돋아난다.',
      '바람이 불 때마다 꽃잎이 눈처럼 흩날린다.',
      '사람들은 두꺼운 외투를 벗고 가벼운 옷을 입는다.',
      '공원 벤치에 앉아 책을 읽는 노인의 표정이 평화롭다.',
      '골목마다 봄나물을 파는 상인들의 목소리가 정겹다.',
      '저녁이 되면 붉은 노을이 하늘을 곱게 물들인다.',
      '하루가 저물어도 사람들의 마음은 따뜻하게 남는다.',
      '그렇게 봄은 조용히 우리 곁으로 다가온다.',
    ],
  },
  {
    title: '컴퓨터와 우리 생활',
    lines: [
      '컴퓨터는 지난 수십 년 동안 우리 생활을 크게 바꾸어 놓았다.',
      '사람들은 멀리 떨어져 있어도 손쉽게 소식을 주고받는다.',
      '도서관에 가지 않아도 수많은 정보를 빠르게 검색할 수 있다.',
      '복잡한 계산도 단 몇 초 만에 정확하게 끝난다.',
      '학생들은 화면을 보며 세계 곳곳의 강의를 듣는다.',
      '의사들은 컴퓨터의 도움으로 더 정밀하게 진단한다.',
      '예술가들은 새로운 도구로 자유롭게 작품을 만든다.',
      '하지만 편리함 속에서 우리는 잠시 멈춰 생각해야 한다.',
      '기계가 대신할 수 없는 것은 사람의 따뜻한 마음이다.',
      '기술은 도구일 뿐, 그것을 쓰는 것은 결국 우리 자신이다.',
    ],
  },
  {
    title: '꾸준함에 대하여',
    lines: [
      '무엇이든 처음 시작할 때는 누구나 서툴고 더디다.',
      '몇 번 해 보다가 마음처럼 되지 않아 쉽게 포기하기도 한다.',
      '그러나 진짜 실력은 짧은 순간에 만들어지지 않는다.',
      '날마다 조금씩 쌓아 올린 노력이 단단한 바탕이 된다.',
      '어제보다 한 걸음 더 나아갔다면 그것으로 충분하다.',
      '작은 성취가 모여 어느새 큰 변화를 이루어 낸다.',
      '서두르지 말고 천천히, 그러나 멈추지 말고 가자.',
      '포기하지 않는 사람만이 끝내 자기 길을 완성한다.',
    ],
  },
  {
    title: '서시 — 윤동주',
